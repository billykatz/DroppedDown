...
extension Statistics {
    ...
    static var allRunesUses101 = Self.init(amount: 101, statType: .totalRuneUses)
    
    // gem cases
    static var blueGems100Collected = Self.init(gemColor: .blue, amount: 100, statType: .gemsCollected)
    static var redGems123Collected = Self.init(gemColor: .red, amount: 123, statType: .gemsCollected)
